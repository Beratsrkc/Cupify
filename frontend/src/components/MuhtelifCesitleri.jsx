...
const MuhtelifGrubu = () => {
    ...
    const [MuhtelifGrubuProducts, setMuhtelifGrubuProducts] = useState([]);
    const [swiperInstance, setSwiperInstance] = useState(null);
    const navigate = useNavigate();

    useEffect(() => {
        const filteredProducts = products.filter(item => item.category === 'Klemens-Takoz-Cesitleri');
        setMuhtelifGrubuProducts(filteredProducts.slice(0, 15));
    }, [products]);

    const handleSeeAllClick = () => {
        navigate('/urunler?category=Klemens-Takoz-Cesitleri');
    };
        ...
        <div className='my-10 relative'>
            <div className='my-10'>
                <div className='flex justify-between items-center text-3xl py-2'>
                    <Title text1={"KLEMENS VE TAKOZ"} text2={"ÇEŞİTLERİ"} />
            ...
            <Swiper
                key={MuhtelifGrubuProducts.length}
            ...
            >
                ...
                {MuhtelifGrubuProducts.map((item, index) => (
